...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    // Only the bot owner (you) can manage this
    ...
    if (sub === 'list') {
      ...
      if (!ids.length) {
        return message.reply('No users have prefixless enabled.');
      }
    ...
    if (!target) {
      return message.reply(
        'Please specify a user by mention or ID. Example: `$prefixless add @User`',
      );
    }
